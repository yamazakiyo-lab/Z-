...
| 2026-08-02 | カレンダースナップショットを毎時更新に増強(タスク TSEG_CalendarExport、毎時0分。8:30・0:00と合わせて最大約1時間遅れ)／利用マニュアル1.2(AI Q&A新機能)を反映／新規アカウント命名ルール制定(姓ローマ字)＋藤澤謙一氏の入社対応(LW・Entra・台帳)／記念日通知を新設(TSEG_記念日通知 毎日8:00、誕生日・入社記念日を山嵜喜隆・山嵜絵里へ。マスタはLWメンバー情報) |
